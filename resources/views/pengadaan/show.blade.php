...
@section('body')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <a href="{{url('/pengajuan/'.$pengadaan->id.'/edit')}}"><button type="button" class="btn btn-success btn-sm" name="button"><span class="fa fa-edit"></span> Edit</button></a>
            <a href="{{url('/pengajuan/'.$pengadaan->id.'/delete')}}"><button type="button" class="btn btn-danger btn-sm" name="button"><span class="fa fa-times"></span> Hapus</button></a>
            <a href="{{url('pengadaan/print/'.$pengadaan->id)}}"><button type="button" class="btn btn-primary btn-sm" name="button"><span class="fa fa-edit"></span> Print</button></a>
